package com.intencity.intencity.util.TwoWayView;
...
public class ItemSelectionSupport
{
    ...
    public static ItemSelectionSupport from(RecyclerView recyclerView) {
        ...
        return (ItemSelectionSupport) recyclerView.getTag(
                R.id.twowayview_item_selection_support);
    }
    ...
    private static class CheckedStates extends SparseBooleanArray implements Parcelable
    {
        ...
        public static final Parcelable.Creator<CheckedStates> CREATOR
                = new Parcelable.Creator<ItemSelectionSupport.CheckedStates>() {
            @Override
            public ItemSelectionSupport.CheckedStates createFromParcel(Parcel in) {
                return new ItemSelectionSupport.CheckedStates(in);
            }

            @Override
            public ItemSelectionSupport.CheckedStates[] newArray(int size) {
                return new ItemSelectionSupport.CheckedStates[size];
            }
        };
    }
    ...
    private static class CheckedIdStates extends LongSparseArray<Integer> implements Parcelable
    {
        ...
        public static final Creator<CheckedIdStates> CREATOR
                = new Creator<ItemSelectionSupport.CheckedIdStates>() {
            @Override
            public ItemSelectionSupport.CheckedIdStates createFromParcel(Parcel in) {
                return new ItemSelectionSupport.CheckedIdStates(in);
            }

            @Override
            public ItemSelectionSupport.CheckedIdStates[] newArray(int size) {
                return new ItemSelectionSupport.CheckedIdStates[size];
            }
        };
    }
