...
public abstract class BaseLayoutManager extends TwoWayLayoutManager
{
    ...
    public boolean checkLayoutParams(LayoutParams lp) {
        if (isVertical()) {
            return (lp.width == LayoutParams.WRAP_CONTENT);
        } else {
            return (lp.height == LayoutParams.WRAP_CONTENT);
        }
    }
    ...
    public LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        ...
        if (isVertical()) {
            lanedLp.width = LayoutParams.WRAP_CONTENT;
            lanedLp.height = lp.height;
        } else {
            lanedLp.width = lp.width;
            lanedLp.height = LayoutParams.WRAP_CONTENT;
        }
