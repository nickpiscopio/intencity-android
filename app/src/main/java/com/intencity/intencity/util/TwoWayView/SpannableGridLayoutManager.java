...
public class SpannableGridLayoutManager extends GridLayoutManager
{
    ...
    protected void moveLayoutToPosition(int position, int offset, Recycler recycler, State state) {
        ...
        final com.intencity.intencity.util.TwoWayView.Lanes lanes = getLanes();
    ...
    @Override ItemEntry cacheChildLaneAndSpan(View child, Direction direction) {
...
//        }
    ...
    public LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        ...
        spannableLp.width = lp.width;
        spannableLp.height = lp.height;
